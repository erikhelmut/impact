...
class IMITATOR:
    ...
    def __init__(self):
        ...
        pretrained_policy_path = Path("/home/erik/impact/src/imitator/outputs/train/impact_planting_real_dirt_gripper/checkpoints/last/pretrained_model")
...
class IMITATORNode(Node):
    ...
    def __init__(self):
        ...
        self.m, self.c = np.load("/home/erik/impact/src/actuated_umi/calibration/20250801-155225.npy")
    ...
    def destroy_node(self):
        ...
        if self.rollout_current_force and self.rollout_goal_force and self.rollout_goal_force_filtered and self.store:
            ...
            run = "planting_task/gripper_control_v2/initial_pos_v4/gc"
